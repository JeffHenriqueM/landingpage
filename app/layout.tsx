...
export const metadata: Metadata = {
  ...
  description:
    "Pare de perder tempo. A solução mais rápida e intuitiva para [Seu Nicho]. Clique agora e fale conosco para receber o link de download direto para o seu iPhone via WhatsApp.",

  // 1.2. OPEN GRAPH (Para WhatsApp, Facebook, LinkedIn)
  openGraph: {
    title: "Seu App iOS Revolucionário - Acesso Imediato",
    description:
      "Fale conosco e comece a usar a nova solução que vai mudar sua vida no iPhone.",
  ...
  twitter: {
    ...
    images: [
      "https://placehold.co/1200x630/059669/white?text=MOCKUP+DO+SEU+APP+AQUI",
    ],
  },
  ...
  return (
    <html lang="pt-BR">
      ...
      <body className={inter.className}>
        {children}
        {/* ========================================================== */}
        {/* TAG GLOBAL DO GOOGLE ADS (AW-16761105675) */}
        {/* ========================================================== */}
        ...
        {/* Script de configuração e dataLayer (inline) */}
